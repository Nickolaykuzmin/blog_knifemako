...
<head>
	...
	<title>Блог ножевого боя.Самозащита</title>
	<meta name="viewport" content="width=device-width,user-scalable=no">
	<script src="http://code.jquery.com/jquery-1.11.0.min.js"></script>
	<link rel="shortcut icon" href="/wp-content/themes/blanc/favicon.ico" type="image/x-icon" />
...
<body <?php body_class(); ?>>
	...
	<header id="header" class="font-quicksand"<?php if( is_front_page() ){ if( get_header_image() ) { echo ' style="border-bottom: none;"'; } else { echo 'style="margin-bottom: 2rem;"'; } } ?>>
		<div class="row">
			...
			<ul class="nav columns large-7 medium-7">
			<?php endif; ?>
