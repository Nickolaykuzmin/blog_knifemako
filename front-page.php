...
if (has_post_thumbnail()) {
	...
	echo '<img src="'.get_template_directory_uri().'/img/no-image.jpg" alt="No Image" width="150" height="150" class="attachment-thumbnail">';
					...
					<a href="<?php the_permalink();?>"><h1 class="entry-title"><?php the_title();
?></h1></a>
...
<?php the_excerpt();?>
					<p class="medium-text-right more"><a href="<?php the_permalink();?>" class="button tiny alert"><?php _e('Читать далее', 'blanc');
?>&nbsp;
